const legalVideoFormats = [
    "mp4","flv","avi","mov","mkv","mpg","3gp","wmv","swf"
];
...
function processFile(files){
    ...
    $("table").append($(`<tr><td colspan="4">影片名稱 : ${thisVideo.name}</td></th>`).css("background-color","yellow"));
    $("table").append(`<tr><td>影片長度</td><td>需介於60~90秒</td><td id="thisDuration"></td><td id="thisDurationResult"></td></tr>`);
    $("table").append(`<tr><td>影片格式</td><td>mp4,flv,avi,mov,mkv,mpg,3gp,wmv,swf</td><td id="thisFormat">${thisVideo.type}</td><td id="thisFormatResult"></td></tr>`);
